          ...
          {loading ? (
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
              {filteredDoctors.map(doctor => (
                <div key={doctor.doctorId} className="group bg-white rounded-2xl shadow-sm hover:shadow-md transition-all duration-300 border border-gray-100 hover:border-cyan-200 overflow-hidden">
                  <div className="flex flex-col items-center p-6">
                    ...
                    <div className="text-center w-full">
                      <h3 className="text-lg font-bold text-gray-800 mb-2 group-hover:text-cyan-600 transition-colors line-clamp-1">
                        {doctor.name}
                      </h3>
                      ...
                      <a 
                        ...
                        className="inline-block bg-gradient-to-r from-cyan-500 to-blue-600 text-white px-5 py-2 rounded-lg text-sm font-medium hover:from-cyan-600 hover:to-blue-700 transition-all duration-200 shadow-sm hover:shadow-md"
                      >
                        Đặt lịch khám
                      </a>
                    </div>
